...
public class face_tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_tab);
        ...
        productsList.add(new Products(1,"SK-Ⅱ","330 ml", "$ 7980", R.drawable.sk2));
        ...
        skin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(face_tab.this, skin_tab.class);
        ...
        body.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(face_tab.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        hair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(face_tab.this, hair_tab.class);
                startActivity(intent);
            }
        });
