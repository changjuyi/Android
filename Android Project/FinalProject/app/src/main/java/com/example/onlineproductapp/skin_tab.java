...
public class skin_tab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skin_tab);
        ...
        productsList.add(new Products(1,"2% BHA Body Spot Exfoliant","210 ml", "$ 1050", R.drawable.bha));
        ...
        hair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(skin_tab.this, hair_tab.class);
        ...
        body.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(skin_tab.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        face.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(skin_tab.this, face_tab.class);
                startActivity(intent);
            }
        });
